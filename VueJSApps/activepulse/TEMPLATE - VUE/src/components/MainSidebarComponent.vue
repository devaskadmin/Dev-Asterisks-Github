...
<template>
  <div class="main-sidebar"
    :class="{
      'collapsed sub-menu-collapsed': isCollapsed, 
      'two-column-menu collapsed': isTwoColumnMenu, 
      'sidebar-mini': isSidebarMini,
      'sub-menu-collapsed': isSubMenuCollapsed, 
      'hoverable': currentNavbarSize === 'expand',
    ...
    <div v-click-outside="closeMainLeftSidebar" class="main-menu">
      <div class="scrollable sidebar-menu" :id="horizontalMenuEnabled ? 'accordionExample' : 'testAccordionExample'">
        ...
        <li class="help-center">
          <h3>Help Center</h3>
          <p>We're an award-winning, forward-thinking team.</p>
